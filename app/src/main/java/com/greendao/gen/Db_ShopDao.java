...
/** 
 * DAO for table "DB__SHOP".
*/
public class Db_ShopDao extends AbstractDao<Db_Shop, Long> {

    public static final String TABLENAME = "DB__SHOP";

    /**
     * Properties of entity Db_Shop.<br/>
    ...
    public Db_ShopDao(DaoConfig config) {
        super(config);
    }
    
    public Db_ShopDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DB__SHOP\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DB__SHOP\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Db_Shop entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Db_Shop entity) {
        stmt.clearBindings();
    ...
    @Override
    public Db_Shop readEntity(Cursor cursor, int offset) {
        Db_Shop entity = new Db_Shop( //
    ...
    @Override
    public void readEntity(Cursor cursor, Db_Shop entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Db_Shop entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Db_Shop entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Db_Shop entity) {
