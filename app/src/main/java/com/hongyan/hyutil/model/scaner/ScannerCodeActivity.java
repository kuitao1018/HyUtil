...
import static com.hongyan.hyutil.model.scaner.RxRegTool.isNullString;
...
public class ScannerCodeActivity extends FragmentActivity {
    ...
    public String SP_SCAN_CODE = "SCAN_CODE";
    ...
    private void initDialogResult(Result result) {
        ...
        RxSPTool.putContent(this, SP_SCAN_CODE, stringToInt(RxSPTool.getContent(this, SP_SCAN_CODE)) + 1 + "");
    }
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        // Here we are swapping, that'GlobalScreenshot the difference to #11
        int tmp = width;
        width = height;
        height = tmp;
