        ...
        if (itemView != null) {
            ...
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    return BaseRecyclerViewAdapter.this.mOnItemLongClickListener != null && BaseRecyclerViewAdapter.this.mOnItemLongClickListener.onItemLongClick(view, BaseRecyclerViewAdapter.this.getItemPosition(holder));
                }
            });
        }
