package com.hongyan.hyutil.model.custom.camera;
...
//            L.e("onPictureTaken called! Launching activity. Delay:", ""+callbackTime - mCaptureTime);
            PicturePreviewActivity.setPictureResult(result);
            Intent intent = new Intent(CameraActivity.this, PicturePreviewActivity.class);
            intent.putExtra("delay", callbackTime - mCaptureTime);
            startActivity(intent);
            mCaptureTime = 0;
            L.e("CameraActivity","onPictureTaken called! Launched activity.");
        }

        @Override
        public void onVideoTaken(@NonNull VideoResult result) {
            super.onVideoTaken(result);
            L.e("CameraActivity","onVideoTaken called! Launching activity.");
            VideoPreviewActivity.setVideoResult(result);
            Intent intent = new Intent(CameraActivity.this, VideoPreviewActivity.class);
            startActivity(intent);
            L.e("CameraActivity","onVideoTaken called! Launched activity.");
        }

        @Override
        public void onVideoRecordingStart() {
            super.onVideoRecordingStart();
            L.e("CameraActivity","onVideoRecordingStart!");
        }
        ...
        public void onVideoRecordingEnd() {
            ...
            L.e("CameraActivity","onVideoRecordingEnd!");
        }
    ...
    private void toggleCamera() {
        ...
        switch (camera.toggleFacing()) {
            case BACK:
                message("Switched to ic_back camera!  +  后面", false);
                break;
            case FRONT:
                message("Switched to front camera!  +  前面", false);
                break;
        }
    }
