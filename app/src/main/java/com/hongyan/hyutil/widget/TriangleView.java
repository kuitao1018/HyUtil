...
public class TriangleView extends View {
    ...
    private static final int DEFUALT_COLOR = R.color.color_red;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mWidth == 0 || widthMode != MeasureSpec.EXACTLY) {
            mWidth = UiUtils.dipTopx(getContext(),DEFUALT_WIDTH);
        }
        if (mHeight == 0 || heightMode != MeasureSpec.EXACTLY) {
            mHeight =UiUtils.dipTopx(getContext(),DEFUALT_HEIGHT);
        }
