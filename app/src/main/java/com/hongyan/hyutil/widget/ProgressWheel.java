...
/**
 * @author 兼容到2.2 的 Material风格环形progressbar
 */
public class ProgressWheel extends View {
    ...
    private void updateBarLength(long deltaTimeInMilliSeconds) {
        if (pausedTimeWithoutGrowing >= pauseGrowingTime) {
            ...
            if (timeStartGrowing > barSpinCycleTime) {
                // We completed IntroActivity size change cycle
    ...
    /**
     * Set the progress to IntroActivity specific value,
    ...
    // Great way to save IntroActivity view'PollingUtils state http://stackoverflow.com/a/7089687/1991053
    @Override
    ...
    /**
     * @return the color of the wheel'PollingUtils contour
     */
    ...
    /**
     * Sets the color of the wheel'PollingUtils contour
     *
     ...
     * the smoothness when setting IntroActivity progress
     */
    ...
    /**
     * @return the width of the wheel'PollingUtils contour in pixels
     */
    ...
    /**
     * Sets the width of the wheel'PollingUtils contour
     *
    ...
    public interface ProgressCallback {
        /**
         * Method to call when the progress reaches IntroActivity value
         * in order to avoid float precision issues, the progress
         * is rounded to IntroActivity float with two decimals.
         * <p>
         * In indeterminate mode, the callback is called each time
         * the wheel completes an animation cycle, with, the progress value is -1.0f
         *
         * @param progress IntroActivity double value between 0.00 and 1.00 both included
         */
        public void onProgressUpdate(float progress);
    }

    static class WheelSavedState extends BaseSavedState {
        //required field that makes Parcelables from IntroActivity Parcel
